...
const baseURL = process.env.GIVEFLOW_E2E_URL ?? 'http://localhost:10075';

// Visual regression project. Opt-in (GIVEFLOW_E2E_VISUAL=1) because screenshot
...
const runVisual = !! process.env.GIVEFLOW_E2E_VISUAL;
...
const runShots = !! process.env.GIVEFLOW_E2E_SHOTS;
