...
<div class="masthead">
    ...
    <?php endif; ?>
    <?php if ($org_tax_id !== ''): ?>
        <p class="ein"><?php echo esc_html(sprintf(/* translators: %s: tax id / EIN */ __('Tax ID (EIN): %s', 'fundraising-toolkit'), $org_tax_id)); ?></p>
    <?php endif; ?>
</div>

<div class="parties">
    <p class="party-label"><?php esc_html_e('Issued to', 'fundraising-toolkit'); ?></p>
...
<h1><?php echo esc_html(sprintf(/* translators: %d: statement year */ __('%d Annual Donation Statement', 'fundraising-toolkit'), $year)); ?></h1>

<p class="intro"><?php echo esc_html(sprintf(
    /* translators: 1: statement year, 2: organization name */
    __('Thank you for your %1$d contributions to %2$s.', 'fundraising-toolkit'),
    $year,
    $org_name
)); ?></p>
...
<p class="footer">
    <?php echo esc_html(sprintf(/* translators: %s: generation date */ __('Generated %s.', 'fundraising-toolkit'), $generated_date)); ?>
    <?php esc_html_e('Retain this statement for your tax records.', 'fundraising-toolkit'); ?>
</p>
</body></html>
