...
$greeting = $donorFirst !== ''
    ...
    ? sprintf(__('Hi %s,', 'giveflow-fundraising-campaigns'), $donorFirst)
    : __('Hi,', 'giveflow-fundraising-campaigns');
?>
<!doctype html>
<html>
...
<p style="background:#fef2f2; border:1px solid #b91c1c; color:#b91c1c; font-weight:700; text-align:center; padding:10px; border-radius:6px; margin:0 0 20px;">
    <?php esc_html_e('Test donation. No real payment was made.', 'giveflow-fundraising-campaigns'); ?>
</p>
<?php endif; ?>
...
<p>
    ...
    printf(
        wp_kses(
            ...
            __('Thank you for your <strong>%1$s</strong> donation to <strong>%2$s</strong>.', 'giveflow-fundraising-campaigns'),
            ['strong' => []]
        ),
...
<p>
    <?php esc_html_e('Reference:', 'giveflow-fundraising-campaigns'); ?>
    <code style="background:#f5f3ef; padding:2px 6px; border-radius:3px"><?php echo esc_html($donation->reference); ?></code>
</p>

<p style="margin-top:24px; font-size:13px; color:#555">
    <?php esc_html_e('Lost the attachment?', 'giveflow-fundraising-campaigns'); ?>
    <a href="<?php echo esc_url($download_url); ?>" style="color:#2271b1"><?php esc_html_e('Re-download your receipt', 'giveflow-fundraising-campaigns'); ?></a>
    <?php esc_html_e('(link expires in 30 days).', 'giveflow-fundraising-campaigns'); ?>
</p>

<p style="margin-top:32px; color:#777; font-size:13px">
    <?php esc_html_e('With gratitude,', 'giveflow-fundraising-campaigns'); ?><br>
