...
namespace GiveFlow\Foundation\Crypto;
 ...
 *
 * Key lives in giveflow_system_settings (encryption_key_v1), auto-generated on first use.
...
final class Crypto
{
    ...
    public function encrypt(string $plaintext): string
    {
        ...
        if ($ciphertext === false) {
            throw new RuntimeException(esc_html('GiveFlow Crypto: encryption failed.'));
        }
    ...
    {
        $result = DB::raw(
            'SELECT 1 FROM ' . DB::getPrefix() . "giveflow_donors
