...
final class LicenseRefusals
{
    ...
    {
        $keepRunning = __('They keep running for now, but they will not receive updates or security fixes.', 'gratora-donation-platform');
        ...
        switch ($status) {
            case 'invalid':
                return [
                    ...
                    'headline' => sprintf(
                        ...
                        __('The license key on this site was not recognised, so %s could not be checked', 'gratora-donation-platform'),
                        $names
                    ),
                    'detail'   => __('Check the key against your purchase email. Until it is accepted they keep running, but they will not receive updates or security fixes.', 'gratora-donation-platform'),
                ];
            ...
            case 'over_limit':
                return [
                    ...
                    'headline' => sprintf(
                        /* translators: %s: comma-separated add-on names */
                        __('Your license has no sites left for %s', 'gratora-donation-platform'),
                        $names
                    ),
                    // Deactivating elsewhere is enough: the client re-activates
                    // on its own next check, with no need to re-enter the key.
                    'detail'   => __('Deactivate the license on a site you no longer use, or move to a larger plan, and this site picks it up on its own.', 'gratora-donation-platform'),
                ];
            ...
            case 'revoked':
                return [
                    ...
                    'headline' => sprintf(
                        /* translators: %s: comma-separated add-on names */
                        __('The license for %s has been revoked', 'gratora-donation-platform'),
                        $names
                    ),
                    'detail'   => $keepRunning,
                ];
            ...
            default:
                return [
                    ...
                    'headline' => sprintf(
                        /* translators: %s: comma-separated add-on names */
                        __('Your license does not cover %s', 'gratora-donation-platform'),
                        $names
                    ),
                    'detail'   => $keepRunning,
                ];
