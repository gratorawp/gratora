...
final class Tokens
{
    ...
    public static function catalogue(): array
    {
        return [
            'gratora-accent' => [
                'group'   => 'brand',
                'label'   => __('Accent', 'gratora-donation-platform'),
                'default' => '#211d3f',
                'control' => 'color',
            ],
            'gratora-accent-soft' => [
                'group'   => 'brand',
                'label'   => __('Accent soft', 'gratora-donation-platform'),
                'default' => '#efedf8',
                'control' => 'color',
                'help'    => __('Translucent variant used for hover and selected tiles.', 'gratora-donation-platform'),
            ],
            'gratora-text' => [
                'group'   => 'brand',
                'label'   => __('Body text', 'gratora-donation-platform'),
                'default' => '#111827',
                'control' => 'color',
            ],
            'gratora-text-muted' => [
                'group'   => 'brand',
                'label'   => __('Muted text', 'gratora-donation-platform'),
                'default' => '#6b7280',
                'control' => 'color',
                'help'    => __('Helper text, placeholders, captions.', 'gratora-donation-platform'),
            ],

            'gratora-bg' => [
                'group'   => 'surface',
                'label'   => __('Background', 'gratora-donation-platform'),
                'default' => '#ffffff',
                'control' => 'color',
                'help'    => __('The card behind the form, and the panels on the campaign page.', 'gratora-donation-platform'),
            ],
            'gratora-field-bg' => [
                'group'   => 'surface',
                'label'   => __('Field background', 'gratora-donation-platform'),
                'default' => '#ffffff',
                'control' => 'color',
                'help'    => __('Inside the boxes a donor types in or picks from.', 'gratora-donation-platform'),
            ],
            'gratora-bg-soft' => [
                'group'   => 'surface',
                'label'   => __('Soft background', 'gratora-donation-platform'),
                'default' => '#f8fafb',
                'control' => 'color',
                'help'    => __('Amount tile resting fill.', 'gratora-donation-platform'),
            ],
            'gratora-border' => [
                'group'   => 'surface',
                'label'   => __('Border', 'gratora-donation-platform'),
                'default' => '#e5e7eb',
                'control' => 'color',
            ],
            ...
            'gratora-typeface' => [
                'group'   => 'typography',
                'label'   => __('Font family', 'gratora-donation-platform'),
                'default' => 'system-ui, -apple-system, "Segoe UI", Roboto, sans-serif',
                'control' => 'font',
            ],
            'gratora-type-size' => [
                'group'   => 'typography',
                'label'   => __('Base font size', 'gratora-donation-platform'),
                'default' => '15px',
                'control' => 'select',
                'options' => [
                    '14px' => '14',
            ...
            'gratora-heading-weight' => [
                'group'   => 'typography',
                'label'   => __('Heading weight', 'gratora-donation-platform'),
                'default' => '600',
                'control' => 'select',
                'options' => [
                    '500' => __('Medium', 'gratora-donation-platform'),
                    '600' => __('Semibold', 'gratora-donation-platform'),
                    '700' => __('Bold', 'gratora-donation-platform'),
                ],
            ],
            'gratora-body-weight' => [
                'group'   => 'typography',
                'label'   => __('Body weight', 'gratora-donation-platform'),
                'default' => '400',
                'control' => 'select',
                'options' => [
                    '400' => __('Regular', 'gratora-donation-platform'),
                    '500' => __('Medium', 'gratora-donation-platform'),
                ],
            ],
            ...
            'gratora-radius' => [
                'group'   => 'radius',
                'label'   => __('Corner radius', 'gratora-donation-platform'),
                'default' => '10px',
                'control' => 'range',
                'min'     => 0,
                'max'     => 24,
                'step'    => 1,
                'help'    => __('Cards, panels and other surfaces.', 'gratora-donation-platform'),
            ],
            'gratora-radius-sm' => [
                'group'   => 'radius',
                'label'   => __('Small corner radius', 'gratora-donation-platform'),
                'default' => '8px',
                'control' => 'range',
                'min'     => 0,
                'max'     => 16,
                'step'    => 1,
                'help'    => __('Buttons, inputs, chips and other controls.', 'gratora-donation-platform'),
            ],
            ...
            'gratora-gap' => [
                'group'   => 'spacing',
                'label'   => __('Block spacing', 'gratora-donation-platform'),
                'default' => '20px',
                'control' => 'range',
                'min'     => 12,
                'max'     => 32,
                'step'    => 2,
                'help'    => __('Vertical rhythm between blocks.', 'gratora-donation-platform'),
            ],
            'gratora-field-gap' => [
                'group'   => 'spacing',
                'label'   => __('Label gap', 'gratora-donation-platform'),
                'default' => '6px',
                'control' => 'range',
                'min'     => 4,
                'max'     => 12,
            ...
            'gratora-button-size' => [
                'group'   => 'buttons',
                'label'   => __('Button height', 'gratora-donation-platform'),
                'default' => '48px',
                'control' => 'range',
                'min'     => 40,
                'max'     => 60,
            ...
            'gratora-button-weight' => [
                'group'   => 'buttons',
                'label'   => __('Button text weight', 'gratora-donation-platform'),
                'default' => '600',
                'control' => 'select',
                'options' => [
                    '500' => __('Medium', 'gratora-donation-platform'),
            ...
            'gratora-button-shadow' => [
                'group'   => 'buttons',
                'label'   => __('Button shadow', 'gratora-donation-platform'),
                'default' => '0 1px 2px rgba(0,0,0,.08)',
                'control' => 'select',
                'options' => [
                    'none'                                  => __('None', 'gratora-donation-platform'),
                    '0 1px 2px rgba(0,0,0,.08)'             => __('Soft', 'gratora-donation-platform'),
                    '0 6px 16px rgba(0,0,0,.12)'            => __('Strong', 'gratora-donation-platform'),
                ],
            ],
            'gratora-button-bg' => [
                'group'   => 'buttons',
                'label'   => __('Button background', 'gratora-donation-platform'),
                'default' => '',
                'control' => 'color',
                'help'    => __('Leave empty to use the accent color.', 'gratora-donation-platform'),
            ],
            'gratora-button-fg' => [
                'group'   => 'buttons',
            ...
            'gratora-button-border' => [
                'group'   => 'buttons',
                'label'   => __('Button border', 'gratora-donation-platform'),
                'default' => '0',
                'control' => 'select',
                'options' => [
                    '0'                       => __('None (filled)', 'gratora-donation-platform'),
                    '1px solid currentColor'  => __('Outline thin', 'gratora-donation-platform'),
                    '2px solid currentColor'  => __('Outline thick', 'gratora-donation-platform'),
                ],
            ],
            'gratora-button-hover-bg' => [
                'group'   => 'buttons',
                'label'   => __('Button hover background', 'gratora-donation-platform'),
                'default' => '',
                'control' => 'color',
                'help'    => __('Leave empty to inherit the button background.', 'gratora-donation-platform'),
            ],

            'gratora-focus-ring' => [
                'group'   => 'elevation',
                'label'   => __('Focus ring color', 'gratora-donation-platform'),
                'default' => '#211d3f',
                'control' => 'color',
            ],
            'gratora-card-shadow' => [
                'group'   => 'elevation',
                'label'   => __('Card shadow', 'gratora-donation-platform'),
                'default' => '0 12px 32px rgba(15, 23, 42, .06)',
                'control' => 'select',
                'options' => [
                    'none'                                       => __('None', 'gratora-donation-platform'),
                    '0 1px 2px rgba(15, 23, 42, .04)'            => __('Soft', 'gratora-donation-platform'),
                    '0 12px 32px rgba(15, 23, 42, .06)'          => __('Floating', 'gratora-donation-platform'),
                    '0 30px 60px rgba(0, 0, 0, .25)'             => __('Dramatic', 'gratora-donation-platform'),
                ],
            ],
        ];
    }
    ...
    {
        return [
            'brand'      => __('Brand colors', 'gratora-donation-platform'),
            'surface'    => __('Surface', 'gratora-donation-platform'),
            'typography' => __('Typography', 'gratora-donation-platform'),
            'radius'     => __('Radius + borders', 'gratora-donation-platform'),
            'spacing'    => __('Spacing', 'gratora-donation-platform'),
            'buttons'    => __('Buttons', 'gratora-donation-platform'),
            'elevation'  => __('Focus + elevation', 'gratora-donation-platform'),
        ];
    }
    ...
    public static function printColor(string $value, string $fallback): string
    {
        ...
        if (preg_match('/^' . Ink::HSL . '$/i', $v) === 1) return Ink::hex($v) ?? $fallback;
    ...
    private static function sanitiseValue(array $def, string $value): ?string
    {
        ...
        switch ($control) {
            case 'color':
                ...
                if (preg_match('/^' . Ink::HSL . '$/i', $value)) return $value;
