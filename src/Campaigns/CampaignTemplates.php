    ...
    public static function all(string $campaignType = ''): array
    {
        $templates = [
            [
                'id'          => self::DEFAULT_ID,
                'category'    => 'General',
                'name'        => __( 'Standard campaign', 'gratora-donation-platform' ),
                'description' => __( 'Image, raised and goal figures, a progress bar, your description, then recent donations and top donors, with the form alongside.', 'gratora-donation-platform' ),
                'best_for'    => __( 'Most campaigns. Start here if none of the others obviously fit.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'hero',
                'category'    => 'General',
                'name'        => __( 'Colour hero', 'gratora-donation-platform' ),
                'description' => __( 'Opens on a full-width band in your campaign colour carrying the title, the figures and the progress bar, with everything else below it.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A campaign that should look like an event rather than a page.', 'gratora-donation-platform' ),
                'form'        => 'everyday',
            ],
            [
                'id'          => 'cover',
                'category'    => 'General',
                'name'        => __( 'Photo cover', 'gratora-donation-platform' ),
                'description' => __( 'Opens on the campaign image running the full width, with the title, the figures and the progress bar laid over it.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A campaign with one photograph strong enough to carry the page.', 'gratora-donation-platform' ),
                'form'        => 'quick-give',
            ],
            [
                'id'          => 'split',
                'category'    => 'General',
                'name'        => __( 'Split panel', 'gratora-donation-platform' ),
                'description' => __( 'The figures sit in a coloured panel next to the form, so the ask and the progress share the first screen.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A short campaign where the number is the argument.', 'gratora-donation-platform' ),
                'form'        => 'everyday',
            ],
            [
                'id'          => 'story',
                'category'    => 'General',
                'name'        => __( 'Story first', 'gratora-donation-platform' ),
                'description' => __( 'A full-width image and the description before any figures at all. The ask comes after the reader knows what they are being asked about.', 'gratora-donation-platform' ),
                'best_for'    => __( 'An appeal that has to explain itself before it asks, and campaigns with a strong photograph.', 'gratora-donation-platform' ),
                'form'        => 'guided',
            ],
            [
                'id'          => 'gallery',
                'category'    => 'General',
                'name'        => __( 'With other campaigns', 'gratora-donation-platform' ),
                'description' => __( 'The usual layout, then a band at the foot showing your other campaigns, so somebody who has just given sees what else needs them.', 'gratora-donation-platform' ),
                'best_for'    => __( 'An organisation running several appeals at once.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'deadline',
                'category'    => 'Appeals',
                'name'        => __( 'Appeal with a deadline', 'gratora-donation-platform' ),
                'description' => __( 'Leads with the goal and how far off it is, puts the form above the fold, and holds the description back until after the ask.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A crisis or a matched appeal, where the reason to give now is the deadline.', 'gratora-donation-platform' ),
            ...
            [
                ...
                'description' => __( 'A colour band carrying what is still needed and how long is left, then the form. Nothing on the page that is not the ask.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A crisis, where anything the reader has to scroll past is a reader you lose.', 'gratora-donation-platform' ),
                'form'        => 'emergency-appeal',
            ],
            [
                'id'          => 'matched',
                'category'    => 'Appeals',
                'name'        => __( 'Matched giving', 'gratora-donation-platform' ),
                'description' => __( 'Raised, goal and donor count together in a coloured band under the title, so the size of the effort reads before the description.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A match or a challenge, where how many have joined in matters as much as the total.', 'gratora-donation-platform' ),
                'form'        => 'everyday',
            ],
            [
                'id'          => 'supporters',
                'category'    => 'Community',
                'name'        => __( 'Supporter wall', 'gratora-donation-platform' ),
                'description' => __( 'The people who have already given are the main content, with their messages shown and the wall running the full width beneath the form.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A community appeal where seeing familiar names is the reason somebody gives.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'leaderboard',
                'category'    => 'Community',
                'name'        => __( 'Leaderboard', 'gratora-donation-platform' ),
                'description' => __( 'Top donors and recent donations carry the page, over a tinted panel of the donor and donation counts.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A competitive campaign, a challenge between teams or offices.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'thermometer',
                'category'    => 'Community',
                'name'        => __( 'Thermometer', 'gratora-donation-platform' ),
                'description' => __( 'The percentage, the amount raised and what is left, large and in colour, with the supporter wall beneath.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A campaign with one number everybody is watching.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'tiers',
                'category'    => 'Impact',
                'name'        => __( 'Impact figures', 'gratora-donation-platform' ),
                'description' => __( 'Three tinted cards carrying the raised total, the number of donors and the average donation, above the image and the form.', 'gratora-donation-platform' ),
                'best_for'    => __( 'An appeal where the shape of the giving is the story.', 'gratora-donation-platform' ),
                'form'        => 'impact-tiers',
            ],
            [
                'id'          => 'transparency',
                'category'    => 'Impact',
                'name'        => __( 'Open books', 'gratora-donation-platform' ),
                'description' => __( 'Four figures across a tinted band: raised, donors, donations and the average, with the image above them.', 'gratora-donation-platform' ),
                'best_for'    => __( 'An organisation that wants the numbers visible before the ask.', 'gratora-donation-platform' ),
                'form'        => 'campaign-page',
            ],
            [
                'id'          => 'minimal',
                'category'    => 'Bare',
                'name'        => __( 'Just the form', 'gratora-donation-platform' ),
                'description' => __( 'Title, description and the donation form. No figures, no donor lists, nothing that needs data to look right.', 'gratora-donation-platform' ),
                'best_for'    => __( 'A page you will design yourself, and a campaign with no goal to show.', 'gratora-donation-platform' ),
                'form'        => 'quick-give',
            ],
        ];
