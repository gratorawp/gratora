...
<h1><?php echo esc_html(sprintf(/* translators: %d: year */ __('Annual donation statement %d', 'giveflow-fundraising-campaigns'), $year)); ?></h1>
<h2><?php echo esc_html($org_name); ?></h2>
<p><?php echo esc_html(sprintf(/* translators: %s: donor name */ __('Issued to %s', 'giveflow-fundraising-campaigns'), $donor_name)); ?></p>
<table>
<thead><tr>
    <th><?php esc_html_e('Date', 'giveflow-fundraising-campaigns'); ?></th>
    <th><?php esc_html_e('Reference', 'giveflow-fundraising-campaigns'); ?></th>
    <th><?php esc_html_e('Currency', 'giveflow-fundraising-campaigns'); ?></th>
    <th style="text-align:right"><?php esc_html_e('Amount', 'giveflow-fundraising-campaigns'); ?></th>
</tr></thead>
<tbody>
    ...
    <tr>
        <td colspan="3" style="text-align:right"><?php
            echo esc_html(count($totals) > 1
                ? sprintf(/* translators: %s: currency code */ __('Total (%s)', 'giveflow-fundraising-campaigns'), $t['currency'])
