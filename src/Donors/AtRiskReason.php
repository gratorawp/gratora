...
final class AtRiskReason
{
    ...
    public static function labels(): array
    {
        return [
            ...
            self::PLAN_PAUSED         => __('Recurring donation paused', 'dono-fundraising-platform'),
            ...
            self::FIRST_DONATION_ONLY => __('First donation, never repeated', 'dono-fundraising-platform'),
