...
final class SecretRedactorTest extends TestCase
{
    ...
    public function test_the_brand_tokens_object_survives_redaction_intact(): void
    {
        $brand = [
            'presets' => [
                ['id' => 'bold', 'tokens' => ['gratora-accent' => '#0F3D5C']],
                ['id' => 'quiet', 'tokens' => ['gratora-accent' => '#111827']],
            ],
            'default_id' => 'bold',
        ];
        ...
        $this->assertSame('#0F3D5C', $out['presets'][0]['tokens']['gratora-accent']);
        $this->assertSame('#111827', $out['presets'][1]['tokens']['gratora-accent']);
    }
}
