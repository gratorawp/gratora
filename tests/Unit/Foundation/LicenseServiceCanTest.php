...
final class LicenseServiceCanTest extends TestCase
{
    ...
    {
        $svc = new LicenseService($this->managerWith(
            $this->module('p2p', GratoraModule::TIER_PRO),
            $this->module('crm', GratoraModule::TIER_PRO),
        ));
    ...
    {
        $svc = new LicenseService($this->managerWith(
            $this->module('free-module', GratoraModule::TIER_FREE),
        ));
    ...
    private function managerWith(GratoraModule ...$modules): ModuleManager
    {
    ...
    private function module(string $id, string $tier): GratoraModule
    {
        return new class($id, $tier) implements GratoraModule {
