...
final class LicenseServiceCanTest extends TestCase
{
    ...
    {
        $svc = new LicenseService($this->managerWith(
            $this->module('p2p', FundKitModule::TIER_PRO),
            $this->module('crm', FundKitModule::TIER_PRO),
        ));
    ...
    {
        $svc = new LicenseService($this->managerWith(
            $this->module('free-module', FundKitModule::TIER_FREE),
        ));
    ...
    private function managerWith(FundKitModule ...$modules): ModuleManager
    {
    ...
    private function module(string $id, string $tier): FundKitModule
    {
        return new class($id, $tier) implements FundKitModule {
