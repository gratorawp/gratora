...
final class SocialMetaTest extends IntegrationTestCase
{
    ...
    public function test_plain_page_emits_no_gratora_social_meta(): void
    {
    ...
    public function test_filter_can_blank_the_tags(): void
    {
        ...
        add_filter('gratora.social_meta', '__return_empty_array');
        try {
            $head = $this->headFor('/?page_id=' . (int) $campaign['page_id']);
        } finally {
            remove_filter('gratora.social_meta', '__return_empty_array');
        }
