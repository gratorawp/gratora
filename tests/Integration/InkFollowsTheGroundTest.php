...
final class InkFollowsTheGroundTest extends IntegrationTestCase
{
    ...
    public function test_a_dark_ground_gets_light_ink(): void
    {
        ...
        $this->assertStringContainsString('--gratora-text:#ffffff;', $css);
        $this->assertStringContainsString('--gratora-text-muted:rgba(255,255,255,.72);', $css);
    }
    ...
    {
        $this->assertStringContainsString('--gratora-text:#10162a;', $this->css(['gratora-bg' => '#ffe066']));
    }
