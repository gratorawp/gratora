...
final class ReceiptOrgLegalNameTest extends IntegrationTestCase
{
    ...
    {
        update_option('giveflow_org_profile', ['name' => '', 'legal_name' => ''], false);
    ...
    public function test_the_receipt_the_donor_downloads_carries_the_legal_name(): void
    {
        ...
        $ref = new \ReflectionMethod(\GiveFlow\Rest\ReceiptsController::class, 'loadOrgProfile');
        $ref->setAccessible(true);
        $org = $ref->invoke(
            \GiveFlow\Foundation\Plugin::instance()->container->get(\GiveFlow\Rest\ReceiptsController::class)
        );
    ...
    public function test_the_annual_statement_carries_the_legal_name(): void
    {
        ...
        $this->assertSame('Helping Hands Foundation e.V.', \GiveFlow\Receipts\OrgProfile::load()['name']);
    }
