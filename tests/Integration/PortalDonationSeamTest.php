...
final class PortalDonationSeamTest extends IntegrationTestCase
{
    public function test_an_add_on_can_add_its_own_section_to_a_donation_payload(): void
    {
        ...
        add_filter('giveflow.portal.donation', static function (array $payload, Donation $donation): array {
    ...
    public function test_the_filter_receives_the_donation_the_payload_describes(): void
    {
        ...
        $seen = null;
        add_filter('giveflow.portal.donation', static function (array $payload, Donation $donation) use (&$seen): array {
            $seen = $donation;
    ...
    public function test_the_extension_registry_offers_a_panel_surface(): void
    {
        ...
        $this->assertStringContainsString('window.giveflow.panels', $inline);
    }
    ...
    private function showDonation(string $reference): array
    {
        ...
        try {
            $res = rest_do_request(new WP_REST_Request('GET', "/giveflow/v1/portal/donations/{$reference}"));
