...
/**
 * EventRetention prunes gratora_events older than the retention window. The prune
...
final class EventRetentionTest extends IntegrationTestCase
{
    ...
    {
        update_option('gratora_privacy', ['event_retention_days' => 0]);
    ...
    private function retention(): EventRetention
    {
        return new EventRetention(
            Plugin::instance()->container->get(\Gratora\Async\AsyncDispatcher::class)
        );
    }
