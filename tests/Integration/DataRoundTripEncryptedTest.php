...
final class DataRoundTripEncryptedTest extends IntegrationTestCase
{
    ...
    {
        $prefix = DB::getPrefix();
        foreach (['gratora_donation_notes', 'gratora_donor_notes', 'gratora_donations', 'gratora_donors'] as $table) {
    ...
    public function test_a_note_whose_body_did_not_survive_the_export_still_lands(): void
    {
        ...
        $this->assertSame(1, $result['created']['gratora_donor_notes'] ?? 0, 'the note was inserted');
