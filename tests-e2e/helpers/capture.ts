...
/** Capture output root. Gitignored; override with GIVEFLOW_E2E_SHOTS_DIR. */
export const SHOTS_DIR = process.env.GIVEFLOW_E2E_SHOTS_DIR
    ? path.resolve(process.env.GIVEFLOW_E2E_SHOTS_DIR)
...
/**
 * Open a wp-admin screen and wait until it is safe to capture. GiveFlow routes
