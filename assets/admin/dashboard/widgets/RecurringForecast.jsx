    ...
    if ( ! recurring || recurring.active_plans === 0 ) {
        return (
            <EmptyState
                ...
                title={ __( 'No recurring plans yet', 'dono' ) }
                body={ __( 'Enable a recurring frequency on your form to unlock predictable monthly revenue.', 'dono' ) }
            />
        );
    }
        ...
        <div className="dono-recurring">
            <div className="dono-recurring__main">
                <div className="dono-recurring__mrr">
                    ...
                    <span className="dono-recurring__suffix">{ __( '/ month', 'dono' ) }</span>
                </div>
                <div className="dono-recurring__sub">
                    { sprintf(
                        /* translators: %d: count */ _n( '%d active plan', '%d active plans', active_plans, 'dono' ),
                        active_plans
                    ) }
                    { new_this_month > 0 && (
                        <>
                            ...
                            <span className="dono-recurring__new">
                                { sprintf(
                                    /* translators: %d: count */ _n( '+%d new this month', '+%d new this month', new_this_month, 'dono' ),
                                    new_this_month
                                ) }
                            </span>
                        </>
            ...
            <div className="dono-recurring__forecast">
                <div className="dono-recurring__forecast-label">{ __( 'Projected next 30 days', 'dono' ) }</div>
