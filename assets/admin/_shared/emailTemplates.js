...
function coreTemplates() {
    return [
        {
            id:        'donation_receipt',
            label:     __( 'Donation receipt', 'gratora-donation-platform' ),
            desc:      __( 'Sent the moment a donation is successfully paid. This is the donor-facing thank you and tax receipt.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        {
            id:        'donation_first',
            label:     __( 'First donation welcome', 'gratora-donation-platform' ),
            desc:      __( 'A one-off welcome sent when a donor gives for the first time, separate from the receipt. Warm and relational, not transactional.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
            tags:      tagsFor( 'donation_first', [ '{donor_first_name}', '{donor_name}', '{organisation_name}' ] ),
        },
        {
            id:        'offline_instructions',
            label:     __( 'Offline donation instructions', 'gratora-donation-platform' ),
            desc:      __( 'Sent when a donor picks bank transfer. Shows IBAN, reference, and amount so they can complete the transfer.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
            tags:      tagsFor( 'offline_instructions', [ '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}', '{bank_details}', '{instructions}' ] ),
        },
        {
            id:        'donation_pending',
            label:     __( 'Pending donation', 'gratora-donation-platform' ),
            desc:      __( 'Sent when a payment is processing (SEPA settlement, delayed cards) before the receipt is issued.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Donation refunded', 'gratora-donation-platform' ),
            desc:      __( 'Sent when an admin refunds a donation. Explains when funds will reappear on the donor card.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
            tags:      tagsFor( 'donation_refunded', [ '{donor_first_name}', '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}' ] ),
        },
        {
            id:        'payment_instructions',
            label:     __( 'Offline payment instructions', 'gratora-donation-platform' ),
            desc:      __( 'The bank-transfer instructions for a payment that is not a donation, such as an order an add-on takes through the same rails.', 'gratora-donation-platform' ),
            recipient: __( 'Payer', 'gratora-donation-platform' ),
        ...
        {
            id:        'payment_pending',
            label:     __( 'Pending payment', 'gratora-donation-platform' ),
            desc:      __( 'The processing notice for a payment that is not a donation, so the payer is not told their purchase was a contribution.', 'gratora-donation-platform' ),
            recipient: __( 'Payer', 'gratora-donation-platform' ),
            tags:      tagsFor( 'payment_pending', [ '{donor_first_name}', '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}' ] ),
        },
        {
            id:        'payment_refunded',
            label:     __( 'Payment refunded', 'gratora-donation-platform' ),
            desc:      __( 'The refund notice for a payment that is not a donation. Same facts as the donation one, without calling the money a donation.', 'gratora-donation-platform' ),
            recipient: __( 'Payer', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring renewal', 'gratora-donation-platform' ),
            desc:      __( 'Sent for each successful renewal of a recurring donation.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring payment failed', 'gratora-donation-platform' ),
            desc:      __( 'Sent the first time a renewal is declined, so the donor can update their card before the donation lapses. Retries do not re-send it.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Subscription cancelled', 'gratora-donation-platform' ),
            desc:      __( 'Sent when a recurring donation is cancelled, either by the donor or by an admin.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring amount changed', 'gratora-donation-platform' ),
            desc:      __( 'Sent when someone at the organization changes the amount of a recurring donation. A donor who changes their own in the portal is not emailed.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring schedule changed', 'gratora-donation-platform' ),
            desc:      __( 'Sent when someone at the organization changes how often a recurring donation is taken. A donor who changes their own in the portal is not emailed.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        {
            id:        'recurring_paused',
            label:     __( 'Recurring donation paused', 'gratora-donation-platform' ),
            desc:      __( 'Sent when someone at the organization pauses a recurring donation, with the date it restarts. A donor who pauses their own in the portal is not emailed.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring donation restarted', 'gratora-donation-platform' ),
            desc:      __( 'Sent when someone at the organization restarts a paused recurring donation, with the next payment date.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
        ...
        },
        {
            ...
            label:     __( 'Next donation skipped', 'gratora-donation-platform' ),
            desc:      __( 'Sent when someone at the organization skips one upcoming payment. The recurring donation itself continues.', 'gratora-donation-platform' ),
            recipient: __( 'Donor', 'gratora-donation-platform' ),
