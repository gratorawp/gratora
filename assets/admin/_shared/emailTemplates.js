...
function coreTemplates() {
    return [
        {
            id:        'donation_receipt',
            label:     __( 'Donation receipt', 'fundraising-toolkit' ),
            desc:      __( 'Sent the moment a donation is successfully paid. This is the donor-facing thank you and tax receipt.', 'fundraising-toolkit' ),
        ...
        {
            id:        'donation_first',
            label:     __( 'First donation welcome', 'fundraising-toolkit' ),
            desc:      __( 'A one-off welcome sent when a donor gives for the first time, separate from the receipt. Warm and relational, not transactional.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
            tags:      tagsFor( 'donation_first', [ '{donor_first_name}', '{donor_name}', '{organisation_name}' ] ),
        },
        {
            id:        'offline_instructions',
            label:     __( 'Offline donation instructions', 'fundraising-toolkit' ),
            desc:      __( 'Sent when a donor picks bank transfer. Shows IBAN, reference, and amount so they can complete the transfer.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
            tags:      tagsFor( 'offline_instructions', [ '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}', '{bank_details}', '{instructions}' ] ),
        },
        {
            id:        'donation_pending',
            label:     __( 'Pending donation', 'fundraising-toolkit' ),
            desc:      __( 'Sent when a payment is processing (SEPA settlement, delayed cards) before the receipt is issued.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Donation refunded', 'fundraising-toolkit' ),
            desc:      __( 'Sent when an admin refunds a donation. Explains when funds will reappear on the donor card.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
            tags:      tagsFor( 'donation_refunded', [ '{donor_first_name}', '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}' ] ),
        },
        {
            id:        'payment_instructions',
            label:     __( 'Offline payment instructions', 'fundraising-toolkit' ),
            desc:      __( 'The bank-transfer instructions for a payment that is not a donation, such as an order an add-on takes through the same rails.', 'fundraising-toolkit' ),
            recipient: __( 'Payer', 'fundraising-toolkit' ),
        ...
        {
            id:        'payment_pending',
            label:     __( 'Pending payment', 'fundraising-toolkit' ),
            desc:      __( 'The processing notice for a payment that is not a donation, so the payer is not told their purchase was a contribution.', 'fundraising-toolkit' ),
            recipient: __( 'Payer', 'fundraising-toolkit' ),
            tags:      tagsFor( 'payment_pending', [ '{donor_first_name}', '{donor_name}', '{organisation_name}', '{amount}', '{campaign_title}', '{reference}' ] ),
        },
        {
            id:        'payment_refunded',
            label:     __( 'Payment refunded', 'fundraising-toolkit' ),
            desc:      __( 'The refund notice for a payment that is not a donation. Same facts as the donation one, without calling the money a donation.', 'fundraising-toolkit' ),
            recipient: __( 'Payer', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring renewal', 'fundraising-toolkit' ),
            desc:      __( 'Sent for each successful renewal of a recurring donation.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring payment failed', 'fundraising-toolkit' ),
            desc:      __( 'Sent the first time a renewal is declined, so the donor can update their card before the donation lapses. Retries do not re-send it.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Subscription cancelled', 'fundraising-toolkit' ),
            desc:      __( 'Sent when a recurring donation is cancelled, either by the donor or by an admin.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring amount changed', 'fundraising-toolkit' ),
            desc:      __( 'Sent when someone at the organization changes the amount of a recurring donation. A donor who changes their own in the portal is not emailed.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Recurring donation restarted', 'fundraising-toolkit' ),
            desc:      __( 'Sent when someone at the organization restarts a paused recurring donation, with the next payment date.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
        ...
        },
        {
            ...
            label:     __( 'Next donation skipped', 'fundraising-toolkit' ),
            desc:      __( 'Sent when someone at the organization skips one upcoming payment. The recurring donation itself continues.', 'fundraising-toolkit' ),
            recipient: __( 'Donor', 'fundraising-toolkit' ),
