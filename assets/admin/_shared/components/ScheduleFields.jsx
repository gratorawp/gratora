...
export default function ScheduleFields( {
    ...
    endsAt,
    onEndsAt,
    title       = __( 'Set a schedule', 'gratora-donation-platform' ),
    sub         = __( 'Add an optional start and end date', 'gratora-donation-platform' ),
    startLabel  = __( 'Start date', 'gratora-donation-platform' ),
    endLabel    = __( 'End date', 'gratora-donation-platform' ),
    startPlaceholder = __( 'Starts immediately', 'gratora-donation-platform' ),
    endPlaceholder   = __( 'No end date', 'gratora-donation-platform' ),
    disabled = false,
    disabledNote = '',
} ) {
