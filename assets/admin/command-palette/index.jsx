...
const commands = [
    {
        ...
        page:     'gratora',
        label:    __( 'Gratora: Open dashboard', 'gratora-donation-platform' ),
        icon:     chartBar,
    ...
    },
    {
        ...
        label:    __( 'Gratora: View donations', 'gratora-donation-platform' ),
        icon:     currencyDollar,
    ...
    },
    {
        name:     'gratora/donors',
        page:     'gratora-donors',
        label:    __( 'Gratora: View donors', 'gratora-donation-platform' ),
        icon:     people,
    ...
    },
    {
        ...
        label:    __( 'Gratora: View campaigns', 'gratora-donation-platform' ),
        icon:     megaphone,
    ...
    },
    {
        name:     'gratora/funds',
        page:     'gratora-funds',
        label:    __( 'Gratora: View funds', 'gratora-donation-platform' ),
        icon:     archive,
    ...
    },
    {
        ...
        label:    __( 'Gratora: Open settings', 'gratora-donation-platform' ),
        icon:     cog,
    ...
    },
    {
        ...
        label:    __( 'Gratora: Open onboarding wizard', 'gratora-donation-platform' ),
        icon:     plus,
    ...
    },
    {
        ...
        page:     'gratora-campaigns',
        label:    __( 'Gratora: New campaign', 'gratora-donation-platform' ),
        icon:     plus,
        callback: ( { close } ) => {
