                ...
                <div className="dd-card__body">
                    <div className="dd-receipt-row">
                        ...
                        <div className="dd-receipt-row__main">
                            <span className="dd-pill is-warn">{ __( 'Receipt queued', 'dono' ) }</span>
                            <div className="dd-receipt-row__meta">
                                { __( 'A receipt will be generated as soon as the renderer runs.', 'dono' ) }
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div key={ r.id } className="dd-receipt-row">
                        ...
                        <div className="dd-receipt-row__main">
                            ...
                            <div className="dd-receipt-row__meta">
                                ...
                                { r.sent_to_email_at && (
                                    <>
                                        { ' · ' }
                                        { __( 'emailed', 'dono' ) } <strong>{ formatDateTime( r.sent_to_email_at ) }</strong>
                                    </>
                                ) }
                                { r.voided && (
                                    <>{ ' · ' }<span style={ { color: 'var(--dd-red, #b42318)' } }>{ __( 'Voided', 'dono' ) }</span></>
                                ) }
                            </div>
                        </div>
                        <div className="dd-receipt-row__actions">
                            ...
                            <button
                                ...
                                onClick={ () => downloadFile( `/dono/v1/admin/receipts/${ r.id }/pdf`, `${ r.receipt_number }.pdf` ).catch( ( e ) => notify.error( e?.message || __( 'Could not download the receipt.', 'dono' ) ) ) }
                            >
