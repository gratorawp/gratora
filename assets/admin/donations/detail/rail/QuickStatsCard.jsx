    ...
    return (
        <div className="dd-rail-card">
            <div className="dd-rail-card__head">
                <span className="dd-rail-card__title">{ __( 'Quick stats', 'gratora' ) }</span>
            </div>
            <div className="dd-rail-card__body">
                <div className="dd-rail-stat">
                    <span className="dd-rail-stat__lbl">{ __( 'Donor lifetime', 'gratora' ) }</span>
                ...
                <div className="dd-rail-stat">
                    <span className="dd-rail-stat__lbl">{ __( 'Previous donation', 'gratora' ) }</span>
                    <span className="dd-rail-stat__val num">
                        { previous
                ...
                { donation.campaign && (
                    <div className="dd-rail-stat">
                        <span className="dd-rail-stat__lbl">{ __( 'Campaign', 'gratora' ) }</span>
                ...
                { donation.paid_at && (
                    <div className="dd-rail-stat">
                        <span className="dd-rail-stat__lbl">{ __( 'Captured', 'gratora' ) }</span>
