    ...
    return (
        <div className="dd-rail-card">
            <div className="dd-rail-card__head">
                <span className="dd-rail-card__title">{ __( 'Metadata', 'giveflow-fundraising-campaigns' ) }</span>
            </div>
            <div className="dd-rail-card__body">
                <div className="dd-rail-stat">
                    <span className="dd-rail-stat__lbl">{ __( 'Created', 'giveflow-fundraising-campaigns' ) }</span>
                    <span className="dd-rail-stat__val" style={ { fontSize: 12.5 } }>{ formatDateTime( donation.created_at ) }</span>
                </div>
                { donation.frequency && (
                    <div className="dd-rail-stat">
                        <span className="dd-rail-stat__lbl">{ __( 'Frequency', 'giveflow-fundraising-campaigns' ) }</span>
                ...
                { donation.country && (
                    <div className="dd-rail-stat">
                        <span className="dd-rail-stat__lbl">{ __( 'Donor country', 'giveflow-fundraising-campaigns' ) }</span>
