/**
 * Money rendering for the surfaces that run inside a Gratora page: the admin
...
export function defaultCurrency() {
    const code = typeof window !== 'undefined' ? window.gratora?.default_currency : '';
...
export function numberFormat() {
    const fmt = typeof window !== 'undefined' ? window.gratora?.number_format : null;
