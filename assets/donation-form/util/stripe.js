...
export function detectStripeReturn( ownReference = null ) {
    ...
    if ( ! clientSecret || params.get( 'gratora_return' ) !== '1' ) return null;

    const reference = params.get( 'gratora_ref' ) || '';
...
export function clearStripeReturnParams() {
    try {
        ...
        [ 'payment_intent', 'payment_intent_client_secret', 'redirect_status', 'gratora_return', 'gratora_ref' ]
